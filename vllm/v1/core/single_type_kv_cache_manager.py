...
class SingleTypeKVCacheManager(ABC):
    ...
    def __init__(
        ...
        if self.dcp_world_size * self.cp_world_size > 1:
            self.block_size *= dcp_world_size * cp_world_size
...
class FullAttentionManager(SingleTypeKVCacheManager):
    ...
    def find_longest_cache_hit(
        ...
        if dcp_world_size * cp_world_size > 1:
...
class SlidingWindowManager(SingleTypeKVCacheManager):
    ...
    def find_longest_cache_hit(
        ...
        assert cp_world_size == 1, "CP not support sliding window attn now."
...
class ChunkedLocalAttentionManager(SingleTypeKVCacheManager):
    ...
    def find_longest_cache_hit(
        ...
        assert cp_world_size == 1, "CP not support chunked local attn now."
        max_num_blocks = max_length // kv_cache_spec.block_size
        if max_length > 0:
...
class MambaManager(SingleTypeKVCacheManager):
    ...
    def find_longest_cache_hit(
        ...
        assert cp_world_size == 1, "DCP not support mamba now."
